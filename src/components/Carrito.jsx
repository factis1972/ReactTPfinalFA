...
const Carrito = () => {
  ...
  if (carrito.length === 0) {
    return (
      <div className="flex flex-row static bg-cover bg-no-repeat bg-center justify-center" style={{ backgroundImage: `url(${DeliveryPizza})` } }  >
        <div className="bg-white/70 backdrop-filter min-h-[60vh] flex flex-col items-center justify-center px-4 my-auto rounded-md">
  ...
  return (
    <div className="flex flex-row static bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${DeliveryPizza})` } }  >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Mi pedido</h1>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {carrito.map((producto, indice) => {
              ...
              return (
                <div 
                  key={indice} 
                  className="bg-white/85 backdrop-filter border border-gray-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow duration-200"
                >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/85 backdrop-filter border border-gray-200 rounded-lg p-6 sticky top-4">
