  ...
  return(
    <>
      <div className="flex flex-row bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${Pizza})` } }  >
        <div className="bg-white/50 backdrop-filter p-10 basis-2/5 text-2xl font-medium text-gray-900 md:text-overflow" >En nuestra tradicional pizzería italiana, cada receta cuenta una historia. <br /><br />
